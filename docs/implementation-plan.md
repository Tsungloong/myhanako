...
> 状态更新：本文是 2026-05-27 至 2026-06-01 的 P0 历史实施计划。2026-06-07 起，P1 当前基准已经提升到 [p1-reference.md](p1-reference.md) 与 [superpowers/plans/2026-06-07-p1-workflow-review-plugin-lab.md](superpowers/plans/2026-06-07-p1-workflow-review-plugin-lab.md)。本文保留用于追溯旧路线中的事件、PromptBundle、可控记忆、Diff、终端和安全边界思想，但不再单独决定 P1 实现方向。
